...
class ItemPhotosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_photo" do
    assert_difference('ItemPhoto.count') do
      post item_photos_url, params: { item_photo: { item_id: @item_photo.item_id, photo: @item_photo.photo } }
    end
  ...
  test "should update item_photo" do
    patch item_photo_url(@item_photo), params: { item_photo: { item_id: @item_photo.item_id, photo: @item_photo.photo } }
